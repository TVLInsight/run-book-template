...
**Service or system name: Insight360 App**
...
_Customer-facing UI for the company and organization information, scores, portfolios, and source articles, with graphical displays_

### Service owner

> Which team owns and runs this service or system?

_Frontend engineering_
...
_NodeJS webapp running under pm2. It communicates with the articles and Qiksay databases directly, and send REST calls to the api_
