...
**Service or system name: DaaS upload**

### Business overview

> What business need is met by this service or system? What expectations do we have about availability and performance?

_Provides external users our DaaS files via a push mechanism to their sftp or S3 bucket_
...
_Scripts which run under cron to transfer the generated DaaS files incrementally to the external datastore_
...
_Bash and python scripts that run on prod-i360-admin2_
